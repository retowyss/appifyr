...
test_that("args_to_json is equal to arg_to_json for single arg", {
  expect_equal(appifyr:::args_to_json(list("bar"), "1337"),
...
test_that("rplot is character", {
  ...
  expect_type(appifyr:::rplot(id = id, rf = "rnorm", json = json), "character")
  expect_type(appifyr:::rplot(id = 5, rf = "rnorm", json = "n : 4"),
              "character")
