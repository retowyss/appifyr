...
I've invested around 100 hours into the development of appifyr - that's spread across writing the  code (R, JavaScript and html), documenting the code, writing unit tests, writing a package documentation, testing apps, and creating a demo application hosted on the cloud server. 
